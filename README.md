...
Выполните в терминале системы данную команду. Второе слово (пакетный менеджер) зависит от конкретной версии вашего Линукс, в нашем тестовом использовалась Fedora 41 workstation поэтому это dnf, для Ubuntu это apt.

Далее будет не лишним обновить pip следующей командой в терминале Visual Studio Code/ др.редактор:
